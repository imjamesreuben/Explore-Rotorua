! function i(a, u, s) {
    ...
    1: [function(e, t, n) {
        ...
        function b(e) {
            ...
            e && e.error && (e.error.title && (t = e.error.title), e.error.message && (n = e.error.message)), y({
                status: "error",
                title: t,
                message: n
            })
        ...
        i(c, {
            ...
            var t = e.data,
                n = t.operation,
                r = t.recaptchaToken;
            "submitEmail" === n ? (o = r, l.submit(a, "POST", [{
                name: "recaptchaToken",
                value: o
            }, {
                name: "sentFromURL",
            ...
            e.preventDefault(), l = new r(e.target, {
                onSuccess: v,
                onError: b,
                beforeSend: y.bind(null, {
                    status: "loading",
                    message: "Sending..."
                })
            }), c.src = u, document.body.appendChild(c), document.body.appendChild(f)
        }, !0), o(f, "click", null, p)
    }, {
        "./src/Form": 6,
        ...
        var o = function() {
            ...
            return r(t, null, [{
                ...
                value: function(n) {
                    ...
                    for (var a in n.beforeSend && n.beforeSend(), i.open(r, o, !0), i.onload = function(e) {
                            if (4 === i.readyState) {
                                var t = {};
                                try {
                                    t = JSON.parse(i.responseText), 200 === i.status ? n.success && n.success(t) : n.error && n.error(t)
                                } catch (e) {
                                    console.error(e)
                                }
                            }
    ...
    4: [function(e, t, n) {
        ...
        var r = function() {
            function r(e) {
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, r), this.element = e, this.id = e.id.trim(), this.text = e.innerText.trim()
            }
            return o(r, [{
                key: "isTag",
                value: function(e) {
        ...
        var i = e("./Component"),
            ...
            r = function(e) {
                function r(e, t) {
                    ...
                    return n.options = t, n.recipient = e.getAttribute("data-bss-recipient"), n.initialize(), n
                }
                return function(e, t) {
                    if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                    e.prototype = Object.create(t && t.prototype, {
                    ...
                    value: function(e, t) {
                        ...
                        switch (e.tagName.toLowerCase()) {
                            case "input":
                                n = "radio" === e.type ? new s(e, this, t) : "checkbox" === e.type ? new a(e, this, t) : "file" === e.type ? new c(e, this, t) : new u(e, this, t);
                                break;
                            case "select":
                                n = new l(e, this, t);
                                break;
                        ...
                        return n.forEach(function(e) {
                            if (e.hasValue())
                                if (e.hasMultipleValues()) {
                                    ...
                                    "checkbox" === e.getType() && e.getSiblings().forEach(function(e) {
                    ...
                    value: function() {
                        var t = [];
                        return this.getFileFields().forEach(function(e) {
                    ...
                    value: function(e, t) {
                        ...
                        o.append("data", JSON.stringify(this.getData())), f.send({
                            url: e,
                            method: t,
                            body: o,
        ...
        var i = e("./Component"),
            o = function(e) {
                ...
                return function(e, t) {
                    ...
                    value: function() {
                        var e = void 0;
                        if (this.id && (e = this.form.find("label[for=" + this.id + "]"))) return new i(e);
                        if (e = this.getParentByTag("label")) return e;
                        var t = this.element.previousElementSibling ? new i(this.element.previousElementSibling) : null;
                    ...
                    value: function() {
                        var t = this;
                        return this.element.name.trim() ? this.form.getFieldsByType(this.constructor).filter(function(e) {
        ...
        var i = e("./FormField"),
            a = function(e) {
                ...
                return function(e, t) {
                    ...
                    key: "hasValue",
                    value: function() {
                        return o(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "hasValue", this).call(this) && this.element.checked
                    }
                }, {
                    key: "getValue",
                    value: function() {
                        var e = this.getLabel(),
                            t = void 0;
                        return e && (t = e.text), {
                            value: t || o(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "getValue", this).call(this),
    ...
    11: [function(e, t, n) {
        ...
        t.exports = function(e, t, u, s, n) {
            var r, l = void 0;
            n = n || !1, (l = e ? "string" == typeof e ? document.querySelector(e) : e : document) && (r = n ? function(e) {
                for (var t = l.querySelectorAll(u), n = e.target, r = 0, o = t.length; r < o; r++)
                    for (var i = n, a = t[r]; i && i !== l;) {
                        if (i === a) return s.call(a, e);
                        i = i.parentNode
                    }
            } : s, l.addEventListener(t, r))
        }
    }, {}]
}, {}, [1]);